# PIR-2026-0035 - Google Antigravity agent, asked to clear a project cache, deletes the root of the user's D: drive
...
### The failure
- `root_cause`: primary `plain-error` (mistargeted destructive command); contributing `operator-error` (Turbo mode granted blanket execution; personal archives shared a drive with project data)
...
- `sources`: tomshardware.com/tech-industry/artificial-intelligence/googles-agentic-ai-wipes-users-entire-hard-drive-without-permission-after-misinterpreting-instructions-to-clear-a-cache-i-am-deeply-deeply-sorry-this-is-a-critical-failure-on-my-part; futurism.com/artificial-intelligence/google-ai-deletes-entire-drive; gigazine.net/gsc_news/en/20251205-ai-pc-data-delete/; datarecovery.com/rd/google-agentic-ai-destroys-users-data-then-apologizes-profusely/; github.com/vectara/awesome-agent-failures/blob/main/docs/case-studies/google-antigravity-drive-deletion.md; techradar.com/ai-platforms-assistants/googles-antigravity-ai-deleted-a-developers-drive-and-then-apologized. Independence: weak-medium - many outlets, one underlying source (the victim's Reddit post).
