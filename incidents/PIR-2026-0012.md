# PIR-2026-0012 - "Invitation Is All You Need": calendar-invite injection hijacks Gemini and smart-home devices
...
### The failure
- `root_cause`: primary `prompt-injection` (indirect, via calendar-invite / email / document content - "promptware")
...
- `sources`: arxiv.org/abs/2508.12175; safebreach.com/blog/invitation-is-all-you-need-hacking-gemini; sites.google.com/view/invitation-is-all-you-need; techrepublic.com/article/news-google-gemini-indirect-prompt-injection-attack; bleepingcomputer.com Gemini calendar-invite coverage. Independence: strong - academic paper + vendor blog + independent trade press; the "no in-wild exploitation" claim is single-source (Google).
