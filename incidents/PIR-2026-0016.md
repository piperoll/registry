# PIR-2026-0016 - 402Bridge private-key leak drains USDC approvals from 227 wallets in the x402 agent-payment ecosystem
...
### The failure
- `root_cause`: primary `credential-exposure` (admin private key); contributing `operator-error` (key custody + permission design that let an ownership transfer unlock `transferUserToken` against user approvals)
...
- `sources`: crypto.news/402bridge-hack-leads-to-over-200-users-drained-of-usdc/ (independent); protos.com/402bridge-private-key-leaks-227-wallets-drained-in-minutes/ (independent); forklog.com/en/402bridge-loses-over-17000-usdc/ (independent); panewslab.com/en/articles/17ffaa3c-2beb-4cd3-b95c-33e26af7567c (SlowMist statement); superex.medium.com/the-explosion-of-the-x402-protocol-and-the-402bridge-security-incident-an-in-depth-analysis-of-12c909bed5f1 (analysis). Independence: good - multiple outlets plus two security firms; team statements corroborate.
