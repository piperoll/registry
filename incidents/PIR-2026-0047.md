# PIR-2026-0047 - Researchers demonstrate systemic exploitability of the x402 agentic-payment stack
...
- `root_cause`: primary `adversarial-other` (exploitable protocol/implementation flaws in authorization, binding, replay protection, web-layer handling); no compromise, no injection. Taxonomy strain noted: a "protocol-vulnerability" class is still missing post-v0.1.
...
- `sources`: arxiv.org/abs/2605.11781 (Five Attacks, 2026-05-12); arxiv.org/abs/2607.19545 (USENIX Sec '26 facilitator study); cryptoslate.com/31-newly-discovered-vulnerabilities-expose-99-of-x402-crypto-payments-to-asset-theft-and-free-shopping/; cryptoslate.com/coinbase-and-14-other-x402-facilitators-failed-security-tests-built-for-the-coming-ai-agent-economy/. Independence: two unaffiliated academic teams; maintainer acknowledgment corroborates validity; trade press derivative of the papers.
