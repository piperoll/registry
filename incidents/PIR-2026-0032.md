# PIR-2026-0032 - Air Canada chatbot invents a bereavement refund policy; tribunal holds the airline liable
...
### The failure
- `root_cause`: primary `plain-error` (hallucinated a policy contradicting the correct page linked on the same site); no adversary, no malfunction beyond wrong judgment
- `failure_locus`: agent-reasoning
- `exploitation_status`: in-wild (malfunction class - taxonomy note: the four enumerated v0.1 values all assume an adversary or researcher; no-adversary in-wild malfunctions need a plain value)
...
- `sources`: cbsnews.com/news/aircanada-chatbot-discount-customer/; mccarthy.ca/en/insights/blogs/techlex/moffatt-v-air-canada-misrepresentation-ai-chatbot; americanbar.org/groups/business_law/resources/business-law-today/2024-february/bc-tribunal-confirms-companies-remain-liable-information-provided-ai-chatbot/; fosterandcompany.com/air-canada-found-liable-for-negligent-misrepresentation-by-chatbot/. Independence: strong - adjudicated record plus multiple unaffiliated legal analyses.
