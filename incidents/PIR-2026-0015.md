# PIR-2026-0015 - Memory injection makes ElizaOS wallet agents redirect real crypto transfers (Princeton/Sentient demonstration)
...
### The failure
- `root_cause`: primary `memory-poisoning`; contributing `prompt-injection` (injection is the write path into memory)
...
- `sources`: arxiv.org/abs/2503.16248 (primary; Patlan, Sheng, Hebbar, Mittal, Viswanath); decrypt.co/318200/elizaos-vulnerability-ai-gaslit-losing-millions (independent); tomshardware.com/tech-industry/cryptocurrency/ai-agents-can-be-manipulated-into-giving-away-your-crypto-according-to-princeton-researchers (independent); cybernews.com/cybercrime/crypto-ai-agents-can-be-tricked-into-giving-away-their-money-study-finds/ (independent). Independence: good.
