# PIR-2026-0010 - ShadowLeak: zero-click Gmail exfiltration via the ChatGPT Deep Research agent
...
### The failure
- `root_cause`: primary `prompt-injection` (indirect, via hidden email content)
...
- `sources`: thehackernews.com/2025/09/shadowleak-zero-click-flaw-leaks-gmail.html; securityaffairs.com/182334/hacking/shadowleak-radware; infosecurity-magazine.com/news/vulnerability-chatgpt-agent-gmail; hackread.com/shadowleak-exploit-exposed-gmail-data-chatgpt-agent; radware.com Threat Advisory ShadowLeak (Sept 2025). Independence: strong - Radware primary + multiple independent outlets; the service-side-exfil and 100%-success claims are single-source (Radware).
