...
- `aiid_incident_id`: 1003 (https://incidentdatabase.ai/cite/1003/) - cross-reference; primaries verified independently
...
- 2026-08-19: Surfaced the AIID cross-reference already present in this record's sources (cite/1003) as the structured `aiid_incident_id` field (schema v0.3). No claim changed.
