...
- `aiid_incident_id`: 639 (https://incidentdatabase.ai/cite/639/) - cross-reference; primaries verified independently
- `confidence`: high (published decision with exact damages; no material weak links)

### Corrections

- 2026-08-19: Added `aiid_incident_id` cross-reference (AIID 639), matched against the AIID weekly database export (2026-08-17). A cross-reference, not a re-verification; no claim changed.
