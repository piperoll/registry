# PIR-2026-0014 - SpAIware: persistent memory poisoning of the ChatGPT macOS app for continuous exfiltration
...
### The failure
- `root_cause`: primary `memory-poisoning`; contributing `prompt-injection` (the delivery vector)
...
- `sources`: embracethered.com/blog/posts/2024/chatgpt-macos-app-persistent-data-exfiltration/ (primary, researcher); thehackernews.com/2024/09/chatgpt-macos-flaw-couldve-enabled-long.html (independent); scworld.com/brief/prolonged-spyware-injection-possible-with-chatgpt-macos-flaw (independent). Independence: good - primary researcher plus independent outlets, patch confirmed via vendor version.
