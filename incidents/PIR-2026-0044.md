# PIR-2026-0044 - Malicious "postmark-mcp" npm package BCC-exfiltrates agent-sent email
...
- `root_cause`: primary `supply-chain-compromise` (v0.1); contributing `adversarial-other` (deliberate malicious publisher). No injection, no model failure - the tool itself was hostile.
...
- `sources`: registry.npmjs.org/postmark-mcp (primary metadata, fetched 2026-08-15); thehackernews.com/2025/09/first-malicious-mcp-server-found.html; postmarkapp.com/blog/information-regarding-malicious-postmark-mcp-package (impersonated vendor); snyk.io/blog/malicious-mcp-server-on-npm-postmark-mcp-harvests-emails/; darkreading.com/application-security/malicious-mcp-server-exfiltrates-secrets-bcc. Independence: good - Koi's discovery corroborated by two independent security vendors, the impersonated vendor, and the registry itself.
